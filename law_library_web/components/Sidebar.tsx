...
export default function Sidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    { href: '/favorites', label: t.navFavorites, icon: <StarIcon /> },
    ...(isAdmin ? [
      { href: '/admin/dashboard', label: t.navDashboard, icon: <ChartIcon /> },
      { href: '/admin/laws', label: t.navManageLaws, icon: <ShieldIcon /> },
      { href: '/admin/users', label: t.navManageUsers, icon: <UsersIcon /> },
    ] : !isLoggedIn ? [
      { href: '/admin', label: t.navLogin, icon: <ShieldIcon /> },
    ] : []),
  ];
  ...
  return (
    <aside className="w-64 min-h-screen bg-blue-900 flex flex-col text-white shrink-0">
      {/* Logo */}
      <div className="px-5 py-4 border-b border-blue-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shrink-0 overflow-hidden">
            <Image src="/logo.png" alt="Law Library Logo" width={36} height={36} className="object-contain" />
          </div>
          <div>
      ...
      <div className="p-3 border-t border-blue-800 space-y-1">
        ...
        {isLoggedIn && (
          <div className="px-3 py-2 mb-1">
            <p className="text-xs text-blue-300">{t.loggedInAs}</p>
            ...
            <span className={`inline-block mt-0.5 text-xs px-1.5 py-0.5 rounded-full font-medium ${
              ...
              {isAdmin ? t.roleAdmin : t.roleOfficer}
            </span>
          </div>
        )}
